...
function Review() {
  return (
    <div className="relative min-h-screen bg-gray-200 overflow-hidden">
      ...
      <div className="mt-30  flex  flex-col justify-center items-center pl-20 m w-3xl ">
        ...
        <p className="text-xl font-medium">
          The easy solution to multi-tenancy Clerk has all the features you need
          to onboard and manage the users and organizations of your multi-tenant
          SaaS application. Learn more about Clerk B2B
        </p>
      </div>
     ...
     <div className="grid grid-cols-3 grid-rows-3 max-w-6xl mx-auto p-4 gap-3 text-gray-800 mt-20 mb-30">
